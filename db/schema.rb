...
ActiveRecord::Schema.define(version: 20141029120540) do
  ...
  create_table "trip_crew_membership_availabilities", force: true do |t|
    t.integer  "trip_id"
    t.integer  "crew_id"
    t.string   "status"
    t.datetime "created_at"
  ...
  create_table "trip_crew_relationships", force: true do |t|
    t.integer  "trip_id"
